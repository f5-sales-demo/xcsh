...
description: >-
  ...
  colecciones de plugins seleccionados.
sidebar:
  order: 4
  label: Marketplace
i18n:
...
Un **plugin** es un directorio que contiene habilidades, comandos, hooks, servidores MCP o servidores LSP. Los plugins se identifican mediante `name@marketplace` (por ejemplo, `code-review@f5xc-salesdemos-marketplace`).
