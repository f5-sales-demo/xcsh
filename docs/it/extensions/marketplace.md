...
Le installazioni con ambito progetto hanno priorità sulle installazioni con ambito utente dello stesso plugin.
...
Il sistema clona il repository (o legge la directory locale), localizza `.xcsh-plugin/marketplace.json`, lo valida e memorizza il catalogo localmente nella cache.
