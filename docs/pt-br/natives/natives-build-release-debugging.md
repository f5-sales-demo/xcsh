...
| --- | --- | --- | --- |
| `Native addon missing exports ... Missing: <name>` | Binário `.node` desatualizado, export Rust incorreto ou binário errado | Use `PI_DEV=1` para ver o caminho; revise os exports | Recompile; alinhe o export ou alias `#[napi]` à chave JS; remova arquivos desatualizados |
