...
Das Marketplace-System ermöglicht es Ihnen, Plugins aus Git-gehosteten Katalogen zu entdecken, zu installieren und zu verwalten. Es ist mit dem Claude Code Plugin-Registry-Format kompatibel.
...
Projektbezogene Installationen überlagern benutzerbezogene Installationen desselben Plugins.
...
| Feld | Beschreibung |
|---|---|
| `name` | Marketplace-Name. Kleingeschriebene alphanumerische Zeichen, Bindestriche und Punkte. Muss mit einem alphanumerischen Zeichen beginnen und enden. Maximal 64 Zeichen. |
...
~/.xcsh/
  ...
  plugins/
    ...
    cache/
      marketplaces/            # Zwischengespeicherte Marketplace-Kataloge
