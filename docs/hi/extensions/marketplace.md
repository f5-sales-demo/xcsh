...
description: >-
  क्यूरेटेड प्लगइन संग्रहों की खोज, इंस्टॉलेशन और प्रबंधन के लिए मार्केटप्लेस
  प्लगइन सिस्टम।
sidebar:
  order: 4
  label: मार्केटप्लेस
...
या बिना किसी आर्गुमेंट के बस `/marketplace` टाइप करें ताकि इंटरैक्टिव प्लगइन ब्राउज़र खुल जाए।
...
एक **प्लगइन** एक डायरेक्टरी है जिसमें स्किल्स, कमांड, हुक्स, MCP सर्वर, या LSP सर्वर होते हैं। प्लगइन को `name@marketplace` द्वारा पहचाना जाता है (जैसे `code-review@f5xc-salesdemos-marketplace`)।
...
प्रोजेक्ट-स्कोप्ड इंस्टॉल समान प्लगइन के यूज़र-स्कोप्ड इंस्टॉल को शैडो करते हैं।
...
| `/marketplace remove <name>` | एक मार्केटप्लेस हटाएं |
| `/marketplace update [name]` | कैटलॉग पुनः प्राप्त करें; सभी को अपडेट करने के लिए नाम छोड़ दें |
...
एक मार्केटप्लेस कैटलॉग रिपॉजिटरी रूट में `.xcsh-plugin/marketplace.json` पर होता है:
...
| फ़ील्ड | विवरण |
|---|---|
| `name` | मार्केटप्लेस नाम। लोअरकेस अल्फ़ान्यूमेरिक, हाइफ़न और डॉट। अल्फ़ान्यूमेरिक से शुरू और समाप्त होना चाहिए। अधिकतम 64 वर्ण। |
...
`source` फ़ील्ड कई फॉर्मेट का समर्थन करता है:

**रिलेटिव पथ** (मार्केटप्लेस रिपो के भीतर):
...
~/.xcsh/
  ...
  plugins/
    ...
    cache/
      ...
      plugins/                 # कैश किए गए प्लगइन डायरेक्टरी
...
मार्केटप्लेस और प्लगइन नामों को:

- लोअरकेस अक्षर या अंक से शुरू और समाप्त होना चाहिए
- केवल लोअरकेस अक्षर, अंक, हाइफ़न और डॉट होने चाहिए
- अधिकतम 64 वर्ण होने चाहिए

प्लगइन ID (`name@marketplace`) कुल मिलाकर अधिकतम 128 वर्ण होने चाहिए।
