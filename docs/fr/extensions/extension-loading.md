...
- Le scan de répertoires configurés explicitement dans `loader.ts` utilise les règles `readdir` et n'applique **pas** le filtrage gitignore.
...
Chaque chemin candidat est chargé par import dynamique :
