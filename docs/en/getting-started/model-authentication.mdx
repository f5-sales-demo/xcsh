...
Use a provider API key for service-style automation. Use a supported subscription login for an interactive user session. Run `xcsh --list-models <provider>` after authentication to confirm the credential can enumerate models.
