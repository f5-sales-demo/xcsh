...
| `/questions` | Opens pending asynchronous questions through the shared session interaction owner. | Focused interaction tests pass; actual terminal qualification is outstanding. |
