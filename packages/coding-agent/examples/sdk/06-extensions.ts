 ...
 * - ~/.xcsh/agent/extensions/ (legacy: ~/.pi/agent/extensions/)
 * - <cwd>/.xcsh/extensions/ (legacy: <cwd>/.pi/extensions/)
...
//   1. Place extension files in ~/.xcsh/agent/extensions/ or .xcsh/extensions/
