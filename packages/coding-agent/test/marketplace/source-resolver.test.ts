...
import type { MarketplacePluginEntry } from "@f5-sales-demo/xcsh/extensibility/plugins/marketplace";
import { resolvePluginSource } from "@f5-sales-demo/xcsh/extensibility/plugins/marketplace";
...
describe("resolvePluginSource", () => {
	...
	beforeEach(() => {
		tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "xcsh-src-res-test-"));
	});
