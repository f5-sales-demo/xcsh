...
import { type PendingExtensionRequest, requestRpcEditor } from "@f5-sales-demo/xcsh/modes/rpc/rpc-mode";
import type { RpcExtensionUIRequest } from "@f5-sales-demo/xcsh/modes/rpc/rpc-types";
