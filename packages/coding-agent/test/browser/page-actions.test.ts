...
import { CdpPageActions } from "../../src/browser/cdp-page-actions";
import { ExtensionPageActions } from "../../src/browser/extension-page-actions";
import type { PageActions } from "../../src/browser/page-actions";
...
describe("PageActions", () => {
	...
	it("ExtensionPageActions structurally satisfies PageActions", () => {
		const fakeExt = {} as import("../../src/browser/extension-provider").ExtensionPage;
