...
| Questions and approvals in both interfaces | Shared broker, pinned schemas, grouped ask, multiple choices/free text, tool routing, queued widgets, real ask host-restart answer, retirement/snapshot recovery and bounds pass | iPhone grouped/multiselect presentation, custom UI, explicit plan and dedicated approvals, remaining control races and manual decision acceptance |
...
| TDD and repository checks | Recorded red-to-green work; grouped-question package suite 7565 pass, 561 skips, zero failures; 369 focused tests, workspace TypeScript and staged privacy checks pass | Final affected suites and required CI; existing full-history PII findings remain unresolved |
