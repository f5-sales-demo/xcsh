...
| Canonical complete history and pagination | Basic turn/item pages; voice provenance and canonical voice notifications | Mixed `thread/timeline/list`, tool items, stable pagination and restart identities |
