...
| Questions and approvals in both interfaces | Broker, grouped ask, tool routing, restart recovery, bounds and plan review/refinement/approval tests pass; decisions and execution lineage persist | iPhone grouped/plan presentation, custom UI, dedicated approvals, external-editor/concurrent-control races and manual decision acceptance |
...
| TDD and repository checks | Recorded red-to-green work; plan-review package suite 7577 pass, 561 skips, zero failures; 359 focused tests, workspace TypeScript and staged privacy checks pass | Final affected suites and required CI; existing full-history PII findings remain unresolved |
