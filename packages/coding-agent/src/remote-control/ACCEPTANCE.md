...
| No Codex installation or subprocess dependency | The current `4a399d39` artifact and two real TUIs pass ten isolated Ubuntu checks without Codex, standalone Bun or source dependencies; real file tools, remote rename, clean and SIGKILL host recovery, active-work continuation, replay and compiled resume verified | Preserve this check on the final release artifact; live subscription/voice evidence remains separate |
...
| TDD and repository checks | Recorded red-to-green work; final guarded package suite passed 8271 tests with 561 skips, 29762 assertions and zero failures across 791 files; 884 current remote tests, workspace types/lint, bundle and ten-check compiled artifact pass; staged PII enforcement is clean and the branch-added audit finding was removed; pinned Rust fixtures and source hashes recorded | Required repository CI; the unchanged repository baseline has 218 HEAD enforcement findings across 13 files |
