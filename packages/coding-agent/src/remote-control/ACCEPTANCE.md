...
| Questions and approvals in both interfaces | Native command/file/general-tool prompts share the broker before/after reattachment; phone/terminal answers, decline, question cancellation and late-answer tests pass; voice mirrors all three item kinds | iPhone grouped/plan presentation, custom UI, dedicated approvals, remaining concurrent control/retry coverage and manual decision acceptance |
