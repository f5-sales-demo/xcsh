...
| Canonical complete history and pagination | Persisted branch/timeline; command outcomes/cancellation receipts; transition/disposal settlement; pinned file-change conversion and history/update tests | Native edit/write execution facts, older command provenance, remaining visible message types, active attachment/fork lifecycle, experimental handling and phone history acceptance |
