...
| No Codex installation or subprocess dependency | Current compiled host and two real TUIs pass nine isolated Ubuntu checks without Codex, standalone Bun or source dependencies; real file tools, clean and SIGKILL host recovery, active-work continuation, replay and compiled resume verified | Preserve this check on the final release artifact; live subscription/voice evidence remains separate |
...
| TDD and repository checks | Recorded red-to-green work; latest guarded package suite 8264 pass, 561 skips and zero failures before the final host recovery changes; 880 current remote tests, workspace types/lint, bundle and nine-check compiled artifact pass; pinned Rust fixtures and source hashes recorded | Final affected package suite and required CI; 218 existing HEAD PII-shaped findings across 13 files remain unresolved |
