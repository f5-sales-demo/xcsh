...
| Discover every live top-level terminal, exclude subagents | Two dedicated terminals discovered and routed correctly | Repair list pagination/sort/filter behavior; verify creation, internal-agent exclusion, scale and stale heartbeats |
...
| TDD and repository checks | Recorded red-to-green work; mixed-timeline suite 7457 pass, 561 skip, zero failures; TypeScript and scoped privacy checks pass | Final affected suites and required CI; existing full-history PII findings remain unresolved |
