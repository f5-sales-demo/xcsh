...
| Relay acknowledgements, chunking, replay and bounds | Codec covers duplicate/reordered chunks, stale/newer assemblies, invalid chunk recovery, oldest-assembly eviction, exact partial/plain acknowledgements, reconnect initialization, closed-stream sequence reset, cursor retention and bounded buffers; pinned transport sources and 148 upstream reference tests provide the baseline | Abrupt packaged relay reconnect and live recovery evidence |
