...
export const CONSOLE_FIELD_METADATA: ConsoleFieldMetadataData = {
	version: "1.0.0",
	resources: {
		http_loadbalancer: {
			"metadata.name": {
			...
			"spec.https_auto_cert": {
				...
				options: ["HTTP", "HTTPS with Automatic Certificate", "HTTPS with Custom Certificate"],
				form_section: "domains-and-lb-type",
				notes: "Selects between spec.http, spec.https, and spec.https_auto_cert",
				mutually_exclusive_with: ["spec.http", "spec.https"],
			},
			"spec.http": {
				widget_type: "listbox",
				label: "Load Balancer Type",
				...
				mutually_exclusive_with: ["spec.https_auto_cert", "spec.https"],
			},
			"spec.https": {
				widget_type: "listbox",
				label: "Load Balancer Type",
				...
				mutually_exclusive_with: ["spec.https_auto_cert", "spec.http"],
			},
			...
			"spec.app_firewall": {
				...
				mutually_exclusive_with: ["spec.disable_waf"],
			},
			"spec.disable_waf": {
				widget_type: "listbox",
				label: "WAF",
				...
				mutually_exclusive_with: ["spec.app_firewall"],
			},
			"spec.waf_exclusion": {
				widget_type: "listbox",
				label: "WAF Exclusion",
				...
				options: ["Inline Rules", "Custom Rules"],
				form_section: "waf",
			...
			"spec.api_specification": {
				...
				mutually_exclusive_with: ["spec.disable_api_definition"],
			},
			"spec.disable_api_definition": {
				...
				mutually_exclusive_with: ["spec.api_specification"],
			},
			...
			"spec.enable_api_discovery": {
				...
				options: ["Disable", "Enable"],
				form_section: "api-protection",
				mutually_exclusive_with: ["spec.disable_api_discovery"],
			},
			"spec.disable_api_discovery": {
				...
				mutually_exclusive_with: ["spec.enable_api_discovery"],
			},
			"spec.sensitive_data_policy": {
				...
				form_section: "api-protection",
				mutually_exclusive_with: ["spec.default_sensitive_data_policy"],
			},
			"spec.default_sensitive_data_policy": {
				...
				mutually_exclusive_with: ["spec.sensitive_data_policy"],
			},
			"spec.api_rate_limit": {
				widget_type: "configurable",
			...
			"spec.disable_api_testing": {
				...
				mutually_exclusive_with: ["spec.api_testing"],
			},
			...
			"spec.l7_ddos_action_block": {
				...
				mutually_exclusive_with: ["spec.l7_ddos_action_default", "spec.l7_ddos_action_js_challenge"],
			},
			"spec.l7_ddos_action_default": {
				...
				mutually_exclusive_with: ["spec.l7_ddos_action_block", "spec.l7_ddos_action_js_challenge"],
			},
			"spec.l7_ddos_action_js_challenge": {
				...
				form_section: "dos-settings",
				mutually_exclusive_with: ["spec.l7_ddos_action_block", "spec.l7_ddos_action_default"],
			},
			...
			"spec.js_challenge": {
				...
				required: false,
				form_section: "dos-settings",
				mutually_exclusive_with: ["spec.captcha_challenge", "spec.no_challenge", "spec.policy_based_challenge"],
			},
			"spec.no_challenge": {
				widget_type: "listbox",
			...
			"spec.active_service_policies": {
				...
				mutually_exclusive_with: ["spec.service_policies_from_namespace", "spec.no_service_policies"],
			},
			"spec.no_service_policies": {
				...
				mutually_exclusive_with: ["spec.service_policies_from_namespace", "spec.active_service_policies"],
			},
			"spec.enable_ip_reputation": {
				...
				options: ["Disable", "Enable"],
				form_section: "common-security-controls",
				mutually_exclusive_with: ["spec.disable_ip_reputation"],
			},
			"spec.disable_ip_reputation": {
				...
				mutually_exclusive_with: ["spec.enable_ip_reputation"],
			},
			"spec.enable_threat_mesh": {
				...
				options: ["Disable", "Enable"],
				form_section: "common-security-controls",
				mutually_exclusive_with: ["spec.disable_threat_mesh"],
			},
			"spec.disable_threat_mesh": {
				...
				mutually_exclusive_with: ["spec.enable_threat_mesh"],
			},
			"spec.user_id_client_ip": {
				...
				mutually_exclusive_with: ["spec.user_identification"],
			},
			...
			"spec.enable_malicious_user_detection": {
				...
				options: ["Disable", "Enable"],
				form_section: "common-security-controls",
				mutually_exclusive_with: ["spec.disable_malicious_user_detection"],
			},
			"spec.disable_malicious_user_detection": {
				...
				mutually_exclusive_with: ["spec.enable_malicious_user_detection"],
			},
			"spec.rate_limit": {
				widget_type: "configurable",
				label: "Rate Limiting",
				...
				mutually_exclusive_with: ["spec.disable_rate_limit"],
			},
			"spec.disable_rate_limit": {
				...
				mutually_exclusive_with: ["spec.rate_limit"],
			},
			...
			"spec.advertise_on_public": {
				...
				required: false,
				default: "Internet",
				options: ["Internet", "Internet with VIP on RE", "Custom"],
			...
			"spec.enable_trust_client_ip_headers": {
				...
				mutually_exclusive_with: ["spec.disable_trust_client_ip_headers"],
			},
			"spec.add_location": {
			...
			"spec.single_lb_app": {
				...
				mutually_exclusive_with: ["spec.multi_lb_app"],
			},
			...
			"spec.malware_protection_settings": {
				...
				mutually_exclusive_with: ["spec.disable_malware_protection"],
			},
			...
			"spec.client_side_defense": {
				...
				disabled: true,
				disabled_reason: "Upgrade required",
				mutually_exclusive_with: ["spec.disable_client_side_defense"],
			},
			"spec.disable_client_side_defense": {
				...
				disabled: true,
				disabled_reason: "Upgrade required",
				mutually_exclusive_with: ["spec.client_side_defense"],
			},
		},
		origin_pool: {
			"metadata.name": {
		...
		alert_policy: {
			...
			"spec.receivers": {
				...
				description:
					"Server-required: at least one Alert Receiver reference. Depends on an existing alert_receiver object (create one first).",
			},
			"spec.routes": {
				widget_type: "nested-resource-list",
				label: "Policy Rules",
