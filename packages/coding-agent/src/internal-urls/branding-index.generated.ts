...
export const BRANDING_CANONICAL = {
  "managed_kubernetes": {
    ...
    "description": "Enterprise-grade Kubernetes cluster management comparable to AWS EKS, Azure AKS, and Google GKE. Full cluster control with RBAC, pod security, and container registry management.\n",
    "legacy_names": [
      "AppStack",
      "VoltStack",
      "voltstack_site"
  ...
  "container_services": {
    ...
    "description": "Simplified, multi-tenant container orchestration comparable to AWS ECS and Azure Container Services. Optimized for distributed edge deployments with restricted Kubernetes capabilities (no operators, CRDs, privileged mode).\n",
    "legacy_names": [
      "Virtual Kubernetes",
      "vK8s",
      "virtual_k8s"
...
export const BRANDING_DOMAIN = {
  "container_services": {
    ...
    "description": "F5 XC Container Services (XCCS) provides simplified, multi-tenant container orchestration comparable to AWS ECS and Azure Container Services. Optimized for distributed edge deployments with restricted Kubernetes capabilities. Formerly known as \"Virtual Kubernetes\" (vK8s).\n"
  },
  "managed_kubernetes": {
    "title": "XCKS - XC Kubernetes Service",
    "description": "F5 XC Managed Kubernetes (XCKS) provides enterprise-grade Kubernetes cluster management comparable to AWS EKS, Azure AKS, and Google GKE. Full cluster control with RBAC, pod security, and container registry management. Formerly known as \"AppStack\".\n"
  },
  "sites": {
    "title": "Customer Edge Sites",
    "description": "Site deployment and management across cloud providers (AWS VPC, Azure VNET, GCP VPC), F5 XC Managed Kubernetes (XCKS, formerly AppStack) deployments, and Secure Mesh deployments for networking-focused edge sites.\n"
  }
} as const;
