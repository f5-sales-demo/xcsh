...
- CORRECT: `full_mesh {\n  data_plane_mesh {}\n}`
- WRONG: `virtual_site = { name = "x", namespace = "demo-app" }` (object literal — NOT a nested block)
