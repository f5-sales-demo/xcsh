...
import { getPluginsLockfile, getPluginsNodeModules, getPluginsPackageJson, isEnoent } from "@f5-sales-demo/pi-utils";
...
/**
 * Load project-local plugin overrides (checks .xcsh and .pi directories).
 */
