...
import type { AgentSession, AgentSessionEvent } from "$c/core/agent-session";
import type { ExtensionUIContext } from "$c/core/extensions/index";
import type { CompactOptions } from "$c/core/extensions/types";
import { HistoryStorage } from "$c/core/history-storage";
import { KeybindingsManager } from "$c/core/keybindings";
import type { SessionContext, SessionManager } from "$c/core/session-manager";
import { getRecentSessions } from "$c/core/session-manager";
import type { SettingsManager } from "$c/core/settings-manager";
import { loadSlashCommands } from "$c/core/slash-commands";
