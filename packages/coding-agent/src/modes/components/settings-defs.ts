...
const OPTION_PROVIDERS: Partial<Record<SettingPath, OptionProvider>> = {
	...
	"compaction.thresholdTokens": [
		...
		{ value: "25000", label: "25K tokens", description: "~50 pages of text" },
		{ value: "50000", label: "50K tokens", description: "~100 pages of text" },
		{ value: "100000", label: "100K tokens", description: "~200 pages of text" },
		{ value: "150000", label: "150K tokens", description: "~300 pages of text" },
		{ value: "200000", label: "200K tokens", description: "~400 pages of text" },
		{ value: "300000", label: "300K tokens", description: "~600 pages of text" },
		{ value: "500000", label: "500K tokens", description: "~1000 pages of text" },
	],
	// Retry max retries
	"retry.maxRetries": [
	...
	"tools.artifactSpillThreshold": [
		{ value: "1", label: "1 KB", description: "~20 lines of code" },
		{ value: "2.5", label: "2.5 KB", description: "~50 lines of code" },
		{ value: "5", label: "5 KB", description: "~100 lines of code" },
		{ value: "10", label: "10 KB", description: "~200 lines of code" },
		{ value: "20", label: "20 KB", description: "~400 lines of code" },
		{ value: "30", label: "30 KB", description: "~600 lines of code" },
		{ value: "50", label: "50 KB", description: "Default; ~1000 lines of code" },
		{ value: "75", label: "75 KB", description: "~1500 lines of code" },
		{ value: "100", label: "100 KB", description: "~2000 lines of code" },
		{ value: "200", label: "200 KB", description: "~4000 lines of code" },
		{ value: "500", label: "500 KB", description: "~10000 lines of code" },
		{ value: "1000", label: "1 MB", description: "~20000 lines of code" },
	],
	"tools.artifactTailBytes": [
		{ value: "1", label: "1 KB", description: "~20 lines kept inline" },
		{ value: "2.5", label: "2.5 KB", description: "~50 lines kept inline" },
		{ value: "5", label: "5 KB", description: "~100 lines kept inline" },
		{ value: "10", label: "10 KB", description: "~200 lines kept inline" },
		{ value: "20", label: "20 KB", description: "Default; ~400 lines kept inline" },
		{ value: "50", label: "50 KB", description: "~1000 lines kept inline" },
		{ value: "100", label: "100 KB", description: "~2000 lines kept inline" },
		{ value: "200", label: "200 KB", description: "~4000 lines kept inline" },
	],
	"tools.artifactTailLines": [
		{ value: "50", label: "50 lines", description: "Very compact tail" },
		{ value: "100", label: "100 lines", description: "Compact tail" },
		{ value: "250", label: "250 lines", description: "Short tail" },
		{ value: "500", label: "500 lines", description: "Default" },
		{ value: "1000", label: "1000 lines", description: "Long tail" },
		{ value: "2000", label: "2000 lines", description: "Very long tail" },
		{ value: "5000", label: "5000 lines", description: "Extensive tail" },
	],
	// Read line limit
	"read.defaultLimit": [
