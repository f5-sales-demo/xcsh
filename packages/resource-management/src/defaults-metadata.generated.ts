...
// Source: https://github.com/f5-sales-demo/api-specs-enriched/releases/download/v4.0.0/minimal-export-defaults.json (api-specs-enriched 4.0.0)
...
export const DEFAULTS_METADATA: Record<string, KindDefaultsMetadata> = {
	...
	api_discovery: {
		serverDefaultFields: [
			...
			"spec.user_defined_api_discovery_policy.discovery_rules",
			"spec.user_defined_api_discovery_policy.inclusive",
		],
		fieldDefaults: {
			"spec.custom_auth_types": [],
			"spec.user_defined_api_discovery_policy.discovery_rules": [],
		...
		minimumConfigFields: [],
		fieldConflicts: {
			"spec.user_defined_api_discovery_policy.exclusive": ["inclusive"],
			"spec.user_defined_api_discovery_policy.exclusive.archive": ["ignore"],
			"spec.user_defined_api_discovery_policy.exclusive.ignore": ["archive"],
			"spec.user_defined_api_discovery_policy.inclusive": ["exclusive"],
		},
	},
	app_firewall: {
		serverDefaultFields: [
	...
	azure_vnet_site: {
		...
		fieldConflicts: {
			...
			"spec.ingress_egress_gw.performance_enhancement_mode.perf_mode_l7_enhanced.jumbo_disabled": ["jumbo_enabled"],
			"spec.ingress_egress_gw.performance_enhancement_mode.perf_mode_l7_enhanced.jumbo_enabled": ["jumbo_disabled"],
			...
			"spec.ingress_egress_gw_ar.performance_enhancement_mode.perf_mode_l7_enhanced.jumbo_disabled": [
				"jumbo_enabled",
			],
			"spec.ingress_egress_gw_ar.performance_enhancement_mode.perf_mode_l7_enhanced.jumbo_enabled": [
				"jumbo_disabled",
			],
			...
			"spec.ingress_gw.performance_enhancement_mode.perf_mode_l7_enhanced.jumbo_disabled": ["jumbo_enabled"],
			"spec.ingress_gw.performance_enhancement_mode.perf_mode_l7_enhanced.jumbo_enabled": ["jumbo_disabled"],
			"spec.ingress_gw_ar": [
				"ingress_egress_gw",
				"ingress_egress_gw_ar",
				"ingress_gw",
			...
			"spec.ingress_gw_ar.performance_enhancement_mode.perf_mode_l7_enhanced.jumbo_disabled": ["jumbo_enabled"],
			"spec.ingress_gw_ar.performance_enhancement_mode.perf_mode_l7_enhanced.jumbo_enabled": ["jumbo_disabled"],
	...
	global_log_receiver: {
		serverDefaultFields: ["spec.ns_current", "spec.request_logs.sampled"],
		fieldDefaults: {
			"spec.ns_current": {},
			"spec.request_logs.sampled": {},
		},
		minimumConfigFields: [
		...
		fieldConflicts: {
			...
			"spec.request_logs.sampled": ["unsampled"],
			"spec.request_logs.unsampled": ["sampled"],
			"spec.s3_receiver": [
				"aws_cloud_watch_receiver",
				"azure_event_hubs_receiver",
				"azure_receiver",
	...
	http_loadbalancer: {
		...
		fieldConflicts: {
			...
			"spec.default_pool.advanced_options.disable_lb_source_ip_persistence": ["enable_lb_source_ip_persistence"],
			...
			"spec.default_pool.advanced_options.enable_lb_source_ip_persistence": ["disable_lb_source_ip_persistence"],
			...
			"spec.jwt_validation.authorization_server": ["jwks_config"],
			"spec.jwt_validation.jwks_config": ["authorization_server"],
	...
	origin_pool: {
		...
		fieldConflicts: {
			...
			"spec.advanced_options.disable_lb_source_ip_persistence": ["enable_lb_source_ip_persistence"],
			...
			"spec.advanced_options.enable_lb_source_ip_persistence": ["disable_lb_source_ip_persistence"],
	...
	rate_limiter: {
		...
		minimumConfigFields: ["spec.limits"],
		fieldConflicts: {},
	},
	rate_limiter_policy: {
	...
	securemesh_site_v2: {
		...
		fieldConflicts: {
			...
			"spec.disable_advanced_delivery": ["enable_advanced_delivery"],
			"spec.disable_ha": ["enable_ha"],
			"spec.disable_log_anonymization": ["enable_log_anonymization"],
			...
			"spec.enable_advanced_delivery": ["disable_advanced_delivery"],
			"spec.enable_ha": ["disable_ha"],
			"spec.enable_log_anonymization": ["disable_log_anonymization"],
			...
			"spec.log_receiver_with_net": ["logs_streaming_disabled"],
			...
			"spec.logs_streaming_disabled": ["log_receiver_with_net"],
			...
			"spec.performance_enhancement_mode.perf_mode_l7_enhanced.jumbo_disabled": ["jumbo_enabled"],
			"spec.performance_enhancement_mode.perf_mode_l7_enhanced.jumbo_enabled": ["jumbo_disabled"],
	...
	service_policy: {
		...
		minimumConfigFields: [
			...
			"spec.segment_policy.dst_segments.segments",
			"spec.segment_policy.src_segments.segments",
		],
		fieldConflicts: {
