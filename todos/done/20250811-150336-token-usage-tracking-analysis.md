...
After reading `/Users/user/workspaces/pi-mono/packages/agent/src/agent.ts` in full, I can confirm that **token usage events are per-request, NOT cumulative**.
...
**Location:** `/Users/user/workspaces/pi-mono/packages/agent/src/agent.ts:16-24`
...
### TUI Renderer
**Location:** `/Users/user/workspaces/pi-mono/packages/agent/src/renderers/tui-renderer.ts`
...
### Console Renderer
**Location:** `/Users/user/workspaces/pi-mono/packages/agent/src/renderers/console-renderer.ts`
...
### SessionManager
**Location:** `/Users/user/workspaces/pi-mono/packages/agent/src/session-manager.ts`
...
**Location:** `/Users/user/workspaces/pi-mono/packages/tui/src/autocomplete.ts`
...
**Location:** `/Users/user/workspaces/pi-mono/packages/agent/src/renderers/tui-renderer.ts:75-80`
...
**Reference:** `/Users/user/workspaces/pi-mono/packages/tui/test/chat-app.ts:25-60`
...
**Location:** `/Users/user/workspaces/pi-mono/packages/agent/src/main.ts:190-198`
