...
The TUI uses a three-strategy rendering system in `renderDifferentialSurgical` (lines 331-513 in `/Users/user/workspaces/pi-mono/packages/tui/src/tui.ts`):
...
Current tests in `/Users/user/workspaces/pi-mono/packages/tui/test/` don't cover the specific scenario of:
