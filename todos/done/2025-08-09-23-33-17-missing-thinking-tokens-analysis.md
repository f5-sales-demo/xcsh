...
The pi-agent codebase already has **comprehensive thinking token support** implemented in `/Users/user/workspaces/pi-mono/packages/agent/src/agent.ts`. The implementation covers both OpenAI's Responses API and Chat Completions API.
...
1. **`/Users/user/workspaces/pi-mono/packages/agent/src/agent.ts`** - Core API handling
2. **`/Users/user/workspaces/pi-mono/packages/agent/src/main.ts`** - Default configuration and model setup
